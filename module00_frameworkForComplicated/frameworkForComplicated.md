...
​					假设驱动法
​						精髓
​							在正式启动前就尝试根据有限的信息得出待检验的问题解决方案
​							假设是对关键议题（关键驱动因素）所提出的可能的答案
​								明确具体
​								通过数据加以证明或驳斥
​							提出假设，解决问题的过程本质上就是通过事实分析验证真伪，从而绘制解决方案路线图
​								正确的问题
​								正确的分析
​								正确的答案
​						使用场景
...
​							理顺分析的优先顺序
​								不做与假设无关的分析
​								快速制胜：先做易于完成，且对证明初始假设有重要贡献的分析
​							不要追求绝对的准确
​								付出过量时间和精力，往往十之八九从大致正确走向精确错误
​								不要追求完美，只追求好于现有的东西，并立即行动，以后再不断完善
​							确定困难问题的范围
​								通过分析，划出答案的可能范围
​								方向正确+范围恰当，很可能足以得出结论
​				然后逐步拆解
...
​											降级
​									利用MECE原则检查是否有重叠和遗漏
​							将归纳总结出的议题进一步归纳，逐步形成议题树
​								MECE原则
​								同一层面原则
​					对熟悉的部分采用自上而下法
​						场景
​							对基础问题所涉及的领域比较熟悉或有现成方法可以解决
​						步骤
​							列出议题树的主干
​								直接经验
​									对某个问题非常了解，处理过很多类似问题
​								计算公式
​									利用公式的核心部分搭建关键议题，再对公式中的要素进行进一步拆解
​									常见公式
​										销售额=销售量*单价
​										利润=销售额-总成本
